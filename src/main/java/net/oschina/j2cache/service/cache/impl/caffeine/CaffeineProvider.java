...
import net.oschina.j2cache.util.matcher.AntPathMatcher;
import net.oschina.j2cache.util.matcher.PatternMatcher;
...
/**
 * ClassName: CaffeineProvider
 * Package: net.oschina.j2cache.service.cache.impl.caffeine
 * Description: Caffeine cache provider
 *
 * @author JX
 * @version 1.0
